...
function SalonForWomanEmployee({ close }) {
  ...
  return (
    ...
    <div className="body_container">
      ...
      <div className="box-sizing">
        ...
        {serviceprovider.filter(provider => provider.serviceType === "Salon for Women").map((provider, index) => (
            <div className="plumbing_service1" key={index}>
              <div className="button-text">
                <div className="image-container1">
                  <img src="/Image/logo1.png" alt="clearning-img" />
                </div>
...
export default SalonForWomanEmployee;
