...
function RepairingEmployee({ close }) {
  const [serviceprovider, setserviceprovider] = useState([]);
    const [showRequest, setshowRequest] = useState(false);

  useEffect(() => {
    fetch("https://home-services-backend-five.vercel.app/api/auth/serviceprovider/list") // ✅ Correct endpoint
    ...
    <div className="body_container">
      ...
      <div className="box-sizing">
        <div className="Employeeid">
          {serviceprovider.filter(provider => provider.serviceType.toLowerCase() === "repairing").map((provider, index) => (
            <div className="plumbing_service1" key={index}>
              <div className="button-text">
                <div className="image-container1">
                  <img src="/Image/Repair1.png" alt="clearning-img" />
                </div>
...
export default RepairingEmployee;
