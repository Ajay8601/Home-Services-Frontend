...
function SpaForMassageEmployee({ close }) {
  ...
  return (
    ...
    <div className="body_container">
      ...
      <div className="box-sizing">
        ...
        {serviceprovider.filter(provider => provider.serviceType === "Spa for women").map((provider, index) => (
...
export default SpaForMassageEmployee;
