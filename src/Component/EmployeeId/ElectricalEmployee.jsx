...
function ElectricalEmployee({ close }) {
  const [serviceprovider, setserviceprovider] = useState([]);
    const [showRequest, setshowRequest] = useState(false);

  useEffect(() => {
    fetch("https://home-services-backend-9zi8.vercel.app//api/auth/serviceprovider/list") // ✅ Correct endpoint
    ...
    <div className="body_container">
      ...
      <div className="box-sizing">
        <div className="Employeeid">
          {serviceprovider.filter(provider => provider.serviceType.toLowerCase() === "electrician").map((provider, index) => (
            <div className="plumbing_service1" key={index}>
              <div className="button-text">
                <div className="image-container1">
                  <img src="public/Image/electricion.png" alt="clearning-img" />
                </div>
...
export default ElectricalEmployee;
