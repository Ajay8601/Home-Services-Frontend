...
function CleaningEmploee({ close }) {
    ...
    <div className="body_container" >
      ...
      <div className="box-sizing">
        <div className="Employeeid">
          {serviceprovider.filter(provider => provider.serviceType.toLowerCase() === "cleaner").map((provider, index) => (
            <div className="plumbing_service1" key={index}>
              <div className="button-text">
                <div className="image-container1">
                  <img src="/Image/cleaning.png" alt="clearning-img" />
                </div>
...
export default CleaningEmploee;
